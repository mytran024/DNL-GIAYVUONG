        ...
        <div className="flex justify-between items-start mb-2 px-4">
          <div className="flex items-start gap-4">
            ...
            <div className="flex flex-col items-center">
              <div className="border-2 border-black w-[110px] h-8 flex items-center justify-center font-bold text-lg tracking-wide leading-none pb-1">DANALOG</div>
        ...
        <div className="space-y-3 mb-6 px-4 text-[14px]">
          <div className="flex items-baseline justify-between">
            <div className="flex items-baseline flex-1">
              ...
              <span className="ml-2 border-b border-dotted border-black px-4 font-bold italic text-blue-900 min-w-[200px]">
                {wo.teamName}
              </span>
            </div>
